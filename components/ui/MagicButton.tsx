const MagicButton = ({
  ...
  return (
    <button onClick={handleClick} className={"relative inline-flex h-12 overflow-hidden rounded-lg p-[1px] focus:outline-none focus:ring-offset-slate-50 md:w-60 md:mt-10"}>
