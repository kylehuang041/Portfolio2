...
function ProjectCard({ proj }: { proj: any }) {
  return (
    <CardBody className="relative bg-[#111110] group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.5] dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border opacity-[0.85]">
      <CardItem
        translateZ="50"
